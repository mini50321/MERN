...
export default function EditCourseModal({
  ...
  useEffect(() => {
    if (course && isOpen) {
      setFormData({
        ...
        category: course.category || "Equipment Maintenance",
        ...
        instructor_credentials: course.instructor_credentials || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let instructorImageUrl = course.instructor_image_url;
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Instructor Photo {instructorImageFile ? "- New File Selected" : course.instructor_image_url ? "- Current: Uploaded" : ""}
                </label>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Course Video {videoFile ? "- New File Selected" : "- Current: " + (course.video_url ? "Uploaded" : "None")} (Max 500MB)
                </label>
                <div className="flex items-center gap-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Course Thumbnail {imageFile ? "- New File Selected" : course.image_url ? "- Current: Uploaded" : ""} (Max 5MB)
                </label>
                <div className="flex items-center gap-3">
                  <label className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg cursor-pointer hover:bg-gray-200 transition-colors">
                    <ImageIcon className="w-4 h-4" />
