...
import { X, Save, Image, Hash, Upload } from "lucide-react";
...
export default function EditNewsModal({ post, isOpen, onClose, onSuccess }: EditNewsModalProps) {
              ...
              <div className="space-y-3">
                <div>
                  <input
                    ...
                    className="hidden"
                    disabled={isSubmitting || (!!imageUrl && !imageFile)}
                  />
                  <button
                    type="button"
